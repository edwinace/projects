...
public class InfotypeListAdapter extends ArrayAdapter<InfotypeModule>{
		private List<InfotypeModule> mList ;
		private LayoutInflater listContainer;  
		private InfotypeModule info;
		...
		public InfotypeListAdapter(Context context, List<InfotypeModule> list) {
		...
		@Override
		public InfotypeModule getItem(int position) {
